                ...
                <#if data?has_content>
                    ...
                    <#if data?has_content && data.rows?has_content>
                        <#list data.rows as log>
                            <article class="group bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row gap-8">
                                <#if log.thumbnail?has_content>
                                    <div class="md:w-1/3 w-full shrink-0 overflow-hidden rounded-2xl relative aspect-[4/3] md:aspect-[4/3]">
                                        <img
                                ...
                                <div class="flex flex-col justify-between flex-grow space-y-4">
                                    <div class="space-y-3">
                                        <div class="flex items-center gap-3 text-xs font-medium text-gray-500 dark:text-gray-400">
                                            <span class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
